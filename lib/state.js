(function exposeSubtleState(root, factory) {
  ...
  const SOURCES = new Set(["youtube", "upload"]);
  ...
  function normaliseState(value) {
    ...
    return {
      ...
      secondarySource: pick(input.secondarySource, SOURCES, DEFAULT_STATE.secondarySource),
  ...
  function availableSecondarySources(platformId) {
    return platformId === "netflix" ? ["upload"] : ["youtube", "upload"];
  }
