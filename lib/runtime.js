  ...
  function createController() {
    ...
    async function loadCues() {
      ...
      const sourceKey = JSON.stringify([
        ...
        tracks.map((track) => [track.id, track.languageCode, track.baseUrl])
      ]);
    ...
    function status() {
      ...
      return {
        ...
        selectedTrack: selectedTrack ? {
          languageCode: adapter.id === "youtube" ? state.targetLanguage : selectedTrack.languageCode,
          label: adapter.id === "youtube" ? state.targetLanguage : selectedTrack.label
        } : null,
